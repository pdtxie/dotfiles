...
Boolean = {fg = "#BDBDDB"},
Character = {fg = "#BDDBBD"},
ColorColumn = {bg = "#2B2B40"},
Comment = {fg = "#7A7A7D", italic = true},
Conceal = {bg = "#3E3E5C"},
Conditional = {fg = "#B87AB8"},
Constant = {fg = "#BDBDDB"},
CursorColumn = {bg = "#2B2B40"},
CursorLine = {bg = "#2B2B40"},
CursorLineNr = {fg = "#55557D"},
Debug = {fg = "#DCDCE0"},
Define = {fg = "#DBBDDB"},
Delimiter = {fg = "#DCDCE0"},
...
LineNr = {fg = "#55557D"},
Macro = {fg = "#DBBDDB"},
MatchParen = {fg = "#F5F5FA", bg = "#55557D", bold = true},
MoreMsg = {fg = "#BDBDDB", bold = true},
NonText = {fg = "#55557D"},
NormalFloat = {bg = "#2B2B40"},
Number = {fg = "#BDBDDB"},
Operator = {fg = "#DBBDDB"},
Pmenu = {bg = "#2B2B40"},
PmenuSbar = {bg = "#3E3E5C"},
PmenuSel = {bg = "#3E3E5C"},
PmenuThumb = {bg = "#55557D"},
PreCondit = {fg = "#DBBDDB"},
PreProc = {fg = "#DBBDDB"},
...
SpellLocal = {sp = "#3E3E5C", underline = true},
SpellRare = {sp = "#55557D", underline = true},
Statement = {fg = "#B87AB8"},
...
Visual = {bg = "#3E3E5C", bold = true},
VisualNOS = {bg = "#3E3E5C"},
WarningMsg = {fg = "#B87A7A"},
Whitespace = {fg = "#55557D"},
WildMenu = {fg = "#7AB8B8", bg = "#253737"},
Winseparator = {fg = "#3E3E5C"},
-- PATCH_CLOSE
-- content here will not be touched
}
