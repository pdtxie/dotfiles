...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    DiffAdd      { bg = indent_green }, -- Diff mode: Added line |diff.txt|
    DiffChange   { bg = indent_yellow }, -- Diff mode: Changed line |diff.txt|
    DiffDelete   { bg = indent_red }, -- Diff mode: Deleted line |diff.txt|
    ...
    Debug          { bg = red, fg = accent_grey }, --   Debugging statements

    Underlined     { gui = "underline" }, -- Text that stands out, HTML links
    Ignore         { fg = bg }, -- Left blank, hidden |hl-Ignore| (NOTE: May be invisible here in template)
    Error          { bg = red, fg = indent_red }, -- Any erroneous construct
    Todo           { bg = yellow, fg = indent_yellow }, -- Anything that needs extra attention; mostly the keywords TODO FIXME and XXX
